...
from TCF_pipeline_CPU import pyTCF_of_2Dslice_CPU

t0 = time.time()
nmodes, sr, r_used = pyTCF_of_2Dslice_CPU(slice2D, L, rvals=rvals, outfile=None, fraction=1., seed=1234)
t1 = time.time()
